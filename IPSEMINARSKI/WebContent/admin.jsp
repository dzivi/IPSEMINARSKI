...
<body>
	<div id="maincontainer">
		...
		<%if (logged==null || logged.getLevelID()==1){
				...
				<div id="centercontent">
					...
					if(userList!=null && userList.size()>0){
						...
						%>
								...
								<a href="Profile?opt=profile&userid=<%=pom.getUserID() %>">	
															
									<li><img src=<%="\""+pom.getProfilePicture()+"\"" %>>
									<span><%=pom.getFirstName()+" "+pom.getLastName() %></span>
									<form action="Remove">
									<input type="hidden" name="userid" value="<%=pom.getUserID()%>">
