				...
				<div id="centercontent">
					...
					<div id="newMess"> 
							<form action="MessagesServlet" method="post">
								<p>Message for <%=userProfile.getFirstName() %> <%=userProfile.getLastName() %></p><br>
								<textarea placeholder='...insert message text...' name='Text'></textarea><br>
								<input type="hidden" name="UserReqID" value="<%=logged.getUserID()%>">
								<input type="hidden" name="UserRespID" value="<%=userProfile.getUserID()%>">
								<input type="hidden" name="FirstName" value="<%=logged.getFirstName()%>">
								<input type="hidden" name="option" value="insert">
								<input type="submit" value='Send message' id='addmessbutton' ><br>
							</form>
							</div>
