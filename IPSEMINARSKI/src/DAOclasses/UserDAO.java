...
public class UserDAO {
	...
	/********* DEFINICIJA METODE ****************************/
	public void insertUser(String FirstName, String LastName, String Birdthday,
			String Sex, String Email, String Password, String CreateDate, String NickName) {
		Connection con = null;
		PreparedStatement pstm = null;
		ResultSet rs = null;
		// POMOCNE PROMENLJIVE ZA KONKRETNU METODU
		...
		try {
			...
			pstm.setString(3, Birdthday);
			pstm.setString(4, Sex);
			pstm.setString(5, Email);
			pstm.setString(6, Password);
			pstm.setString(7, CreateDate);
